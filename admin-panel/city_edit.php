...
if(isset($_POST['submit12345'])){
	...
	$insert_bookings = "UPDATE `city` SET
...
$sql_insert->execute();
	...
	$status="success";
	header("Location: city.php?id=$id&message=1&status=success");
		
}

if($id !=''){
 $select_bookings= "SELECT * FROM `city` WHERE id = '".$_REQUEST['id']."'";
							...
							<?php if($_REQUEST['message']!="") { 
                                ...
                                <form id="formID" class="m-t-30" method="post" action="">    
									...
									<div class="form-group">
										...
										<input name="city_name" required=''   type="text" class="form-control" id="city_name" aria-describedby="emailHelp" value=" <?php echo $rows->city_name; ?>" >
