                    ...
                    <div class="col-12">
                        <div class="card">
                          ...
                          <form id="formID" class="m-t-30" method="post" action="" enctype="multipart/form-data" > 
                                    ...
                                    <div class="form-group m-b-30 row">
                                        <div class="col-md-6">
                                            <label for="bua">Total No Of Floors</label>
                                    ...
                                    <div class="box-body row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="custom-select mr-sm-2" id="prop_parking" name="prop_parking" >
                                                ...
                                                <option <?php echo $rows->prop_parking == '2 Wheeler' ? 'selected' : '';?>>2 Wheeler</option>
                                                <option <?php echo $rows->prop_parking == '3 Wheeler' ? 'selected' : '';?>>3 Wheeler</option> 
                                                <option <?php echo $rows->prop_parking == '4 Wheeler' ? 'selected' : '';?>>4 Wheeler</option> 
                                            </select>
                                        </div>
                                    </div>                                                  
                                    </div>
