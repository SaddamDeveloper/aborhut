...
Guwahati, Assam, Pincode: 781034
                            ...
                            <li>
                                ...
                                Email: <a href="mailto:sales@hotelempire.com">sales@aborhut.com</a>
                            </li>
                            <li>
                                <i class="fa fa-phone"></i>
                                Phone: <a href="tel: 095085-10998">095085-10998</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row clearfix">
            <div class="col-md-8 col-sm-12">
                &copy;  2020 Aborhut | Developed By <a href="https://www.webinfotech.net.in/" target="_blank">Webinfotech</a>
            </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <p>
                    Mandakini Path, Jatia, Kahilipara,
Guwahati, Assam, Pincode: 781034
                </p>
                <span class="ratings">
