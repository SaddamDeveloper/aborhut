...
$select_enquiry="SELECT * FROM location order by id desc limit 20";
 ...
 $select_bookings= "SELECT * FROM `landlord` WHERE id = '".$_SESSION["id"]."'";
                            ...
                            <?php if($_REQUEST['message']!="") { 
                                ...
                                <form id="formID" class="m-t-30" method="post" action="" enctype="multipart/form-data"> 
                                    ...
                                    <div class="form-group"  style="display: none;">
                                        <label  for="exampleInputEmail1">Landlord id</label>
                                        <input name="prop_landlord_id" required=''   type="text" class="form-control" id="prop_landlord_id" aria-describedby="emailHelp" value=" <?php echo $rows3->id; ?>" >
                                        <small id="emailHelp" class="form-text text-muted"></small> 
                                    </div> 
