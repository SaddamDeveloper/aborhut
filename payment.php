...
<section id="content">
		<div class="content-blog">
              ...
              <div class="container"> 
                ...
                <br/>
              <?php } ?> 
								<form action="paynow.php" class="m-t-30" method="post" name="payuForm">
                <input type="hidden" name="name" value="<?php echo $rows->chk_bill_name ?>">
                <input type="hidden" name="email" value=" <?php echo $rows->chk_bill_email ?>">
                <input type="hidden" name="phone" value=" <?php echo $rows->chk_bill_phone ?>">
          ...
          <input type="hidden" name="service_provider" value="payu_paisa" size="64" />
					<?php if(!$hash) { ?>
            <td colspan="4"><input type="submit" value="Pay Now"  name="loginsubmit" id = "loginsubmit"  class="btn btn-primary" /></td>
          <?php } ?>
        </form>
		</div>
		</div>
