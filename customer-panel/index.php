...
if(isset($_POST['button'])){
    ...
    foreach($wlvd as $row5)
    {
		  ...
		  $_SESSION['cus_phone'] = $row5->cus_phone;
                        ...
                        <div class="col-12">
                            <form name="loginform" class="col-12" id="loginform"  method="post">
                                <div class="input-group mb-3">
									...
									<input type="text" name="cus_phone" id="cus_phone"  class="form-control form-control-lg" required="" placeholder="Mobile Number" aria-label="Mobile Number" aria-describedby="basic-addon1">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" name="cus_password" id="cus_password" class="form-control form-control-lg" required="" placeholder="Password" aria-label="Password" aria-describedby="basic-addon1">
                                </div>
                                ...
                                <div class="form-group m-b-0 m-t-10">
                                    ...
                                    <div class="col-sm-12 text-center">
                                        Don't have an account? <a href="../appointment.php" class="text-info m-l-5"><b>Sign Up</b></a>
                                    </div>
                                </div>
                            </form>
                        </div>
