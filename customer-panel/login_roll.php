...
if(isset($_POST['button'])){
	...
	$st_rollno = $_POST['st_rollno'];
	$st_password = $_POST['st_password'];
	
	
    $select  = "select * from `student` WHERE st_rollno = '".$st_rollno."' and st_password = '".$st_password."'";
            ...
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        ...
                        <h5 class="font-medium m-b-20">Sign In to Goreswar College</h5>
                        <?php echo $error ?>
                    </div>
                    <!-- Form -->
                    <div class="row">
                        <div class="col-12">
                            <form name="loginform" class="col-12" id="loginform"  method="post"">
                                <div class="input-group mb-3">
									...
									<input type="text" name="st_rollno" id="st_rollno"  class="form-control form-control-lg" required="" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
